...
export async function getAllServices(req: express.Request, res: express.Response, next: express.NextFunction) {
    try{
...
export async function getServiceById(req: express.Request, res: express.Response, next: express.NextFunction) {
    try{
        const {id} = req.params;
...
export async function postServiceCategory(req: express.Request, res: express.Response, next: express.NextFunction) {
try {
...
export async function GetAllServiceCategory(req: express.Request, res:express.Response, next: express.NextFunction){
    try {
...
export async function updateService(req: express.Request, res: express.Response, next: express.NextFunction) {
    try {
        const {id} = req.params;
        const {name, description, price, categoryId} = req.body;
        if(!name || !description || !price || !categoryId){
...
export async function deleteService(req: express.Request, res: express.Response, next: express.NextFunction) {
    try {
        const {id} = req.params;
        const service = await prisma.service.findUnique({
            where: {id: parseInt(id)}
...
export async function createBooking(req: express.Request, res: express.Response, next: express.NextFunction) {
  ...
  export async function getAllBookings(req: express.Request, res: express.Response) {
    try {
    ...
    export async function getBookingById(req: express.Request, res: express.Response) {
        try {
        const { id } = req.params;
